...
<body>
         ...
         <div class="container flex">
            ...
            <div class="book-details">
               <div class="book-description">
                  ...
                  <div id="paginas">
                     <?php $paginaActual = 1; ?>
                     <?php foreach ($book->paginas as $index => $pagina): ?>
                        <div class="pagina" id="pagina-<?= $index + 1 ?>" style="display: <?= $index + 1 === $paginaActual ? 'block' : 'none' ?>;">
                           <?= $pagina->page_content ?>
                        </div>
                     <?php endforeach; ?>
                     <div class="pagination mt-3" style="margin-top: 10px;">
                        <button class="cta-button" id="anterior" disabled>Anterior</button>
                        <button class="cta-button" id="siguiente">Siguiente</button>
                     </div>
                  </div>
               </div>
      </section>
   ...
   <script>
      ...
      function mostrarPagina(pagina) {
         ...
         siguienteBtn.disabled = pagina === paginas.length;

         paginaActual = pagina;
      }

      siguienteBtn.addEventListener('click', () => mostrarPagina(paginaActual + 1));
      anteriorBtn.addEventListener('click', () => mostrarPagina(paginaActual - 1));
